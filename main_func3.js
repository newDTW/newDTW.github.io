...
function func337(func){					// 
	if(!func){
		throw ""
	}
	funclist.push(func);
	await(func337_1, var_686);
}
function func337_1(){
	redraw(2);
	if ( var_163 == 1 || var_151 >= 1 ) {
...
/*	var_765 = 1;
	...
	while(true){
		...
		var_300 = 1;
		var_766 = var_func341 % 6;
	}
	var_765 = 0;
	return;*/
}
function func342(){							// 体力等のパラメータの描画
	if ( var_1233 == 1 ) {
		return;
	}
	gmode(2);
...
function func354(){						// 6000行以上あるアホとしか言いようが無い関数
	pos(var_1286, var_1287);
	gmode(2);
	if ( var_1297 >= 1 ) {
	...
	if ( var_584 >= 1 ) {
		for(var j=0; j<100; j++){
			pos(var_587[j][1], var_587[j][2]);
			if ( var_587[j][3] == 0 && var_587[j][0] == 0 ) {
				gcopy(3, 560, 160, 20, 20);
			}
			if ( var_587[j][3] == 1 && var_587[j][0] == 0 ) {
				gcopy(3, 580, 160, 20, 20);
			}
			if ( var_587[j][3] == 2 && var_587[j][0] == 0 ) {
				gcopy(3, 560, 180, 20, 20);
			}
			if ( var_587[j][3] == 3 && var_587[j][0] == 0 ) {
				gcopy(3, 580, 180, 20, 20);
			}
			if ( var_587[j][3] == 0 && var_587[j][0] == 1 ) {
				gcopy(3, 600, 160, 20, 20);
			}
			if ( var_587[j][3] == 1 && var_587[j][0] == 1 ) {
				gcopy(3, 620, 160, 20, 20);
			}
			if ( var_587[j][3] == 2 && var_587[j][0] == 1 ) {
				gcopy(3, 600, 180, 20, 20);
			}
			if ( var_587[j][3] == 3 && var_587[j][0] == 1 ) {
				gcopy(3, 620, 180, 20, 20);
			}
			if ( var_587[j][3] == 0 && var_587[j][0] == 2 ) {
				gcopy(3, 640, 160, 40, 40);
			}
			if ( var_587[j][3] == 1 && var_587[j][0] == 2 ) {
				gcopy(3, 680, 160, 40, 40);
			}
			if ( var_587[j][3] == 2 && var_587[j][0] == 2 ) {
				gcopy(3, 720, 160, 40, 40);
			}
			if ( var_587[j][3] == 3 && var_587[j][0] == 2 ) {
				gcopy(3, 760, 160, 40, 40);
			}
			var_587[j][1] = var_587[j][1] - var_587[j][4];
			var_587[j][2] = var_587[j][2] + var_587[j][5];
			var_587[j][3] = var_587[j][3] + 1;
			if ( var_587[j][3] == 4 ) {
				var_587[j][3] = 0;
			}
		}
...
function func367(){
	...
	if ( var_802 >= 100 && var_802 < 400 && var_862[var_802][0] != 0 ) {
		...
		var_809 = 1;
		for(var j=0; j<var_810 + var_807; j++){
...
function func384(){
	...
	for(var j=0; j<i; j++){	// よくわからんfor文
		...
		if ( var_1732 >= 1 ) {
			for(var k=0; k<30; k++){
				var_78[var_866][k] = var_991[1][var_1732][k];
			}
...
function func388(){
	...
	if ( var_1786 == 0 || var_1766 == 1 ) {
		...
		var_1791 = 21;
		var_1792 = 0;
		for(var j=0; j<var_1788; j++){
			func389();
			var_1793 = 20;
			var_1794 = 0;
			for(var k=0; k<var_1788 + 1; k++){
