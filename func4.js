...
function func470() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (var_2083 == 815 && var_233[var_1876][7] >= 1) {
            ...
            var_2089 = var_683 + 1;
            for (var i = 0; i < 30; ++i) {
                var_486[var_682][var_2089][i] = var_486[var_682][var_683][i];
            }
            return;
        }
        if (var_2083 == 807) {
...
function func471() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (var_2083 == 816) {
            ...
            for (var i = 0; i < 30; ++i) {
                var_486[var_682][var_683][i] = var_78[var_866][i];
            }
        ...
        if (var_232 == 995) {
            ...
            if (var_82[var_347][var_348] != 0) {
                ...
                if (var_2232 == 1) {
                    ...
                    var_2233 = var_1038 + 1;
                    var_2234 = 0;
                    for (var i = 0; i < var_2233; ++i) {
                        if (var_989[i] == var_83[var_2231][0]) {
                            var_2234 = 1;
                            var_1610 = i;
                            break;
                        }
